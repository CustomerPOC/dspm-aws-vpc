...
# List all VPCs with the specified tag value
#VPC_IDS=$(aws ec2 describe-vpcs --filters "Name=tag:$TARGET_TAG_KEY,Values=$TARGET_TAG_VALUE" --query "Vpcs[*].VpcId" --output text)
